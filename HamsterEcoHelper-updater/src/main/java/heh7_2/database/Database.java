...
public class Database implements Cloneable {
    ...
    public Database(File dbFile) throws SQLException, ClassNotFoundException {
        database = new SQLiteDatabase(newJdbcConnection(dbFile));
    }
    ...
    public List<ShopStorageLocation> getChestLocations() {
        return database.getUnverifiedTable(ShopStorageLocation.class).select(WhereClause.EMPTY);
    }
    ...
    public List<LottoStorageLocation> getLottoStorageLocations() {
        return database.getUnverifiedTable(LottoStorageLocation.class).select(WhereClause.EMPTY);
    }
    ...
    public List<Invoice> getInvoices() {
        ITypedTable<Invoice> table = database.getUnverifiedTable(Invoice.class);
        List<Invoice> select = table.select(WhereClause.EMPTY);
        return select;
    }
